...
<video controls src="docs/png/gardening_lab3_動作イメージ.mp4" title="Title"></video>
...
| 本日の記録                                                                               | 1週間の記録                                                                                                                 |
| ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| <video controls src="docs/png/gardening_lab3_today.mp4" title="Title"></video>           | <video controls src="docs/png/gardening_lab3_weekly.mp4" title="Title"></video>                                             |
| 閲覧日の記録を閲覧時刻に合わせて表示するようにした。閲覧したい日を選択することができる。 | 1週間の記録を閲覧できるようにし、時系列で並べたグラフと最大・最小・平均というデータを集計したグラフを選択できるようにした。 |

| 写真ページ                                                                                         |
| -------------------------------------------------------------------------------------------------- |
| <video controls src="docs/png/gardening_lab3_photo.mp4" title="Title"></video>                     |
